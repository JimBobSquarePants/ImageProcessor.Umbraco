...
namespace ImageProcessor.Umbraco.PackageActions
{
	...
	public class AddHttpModule : IPackageAction
	{
		...
		/// </summary>
		public const string Name = "ImageProcessorModule";

		/// <summary>
		/// The type of the HttpModule.
		/// </summary>
		public const string Type = "ImageProcessor.Web.HttpModules.ImageProcessingModule, ImageProcessor.Web";
		...
		public static bool Test()
		{
			...
			{
				Log.Add(LogTypes.Error, -1, string.Format("Error at testing {0} package action. {1}", ActionAlias, ex));
				return false;
			}
		}
		...
		public bool Execute(string packageName, XmlNode xmlData)
		{
			...
			{
				Log.Add(LogTypes.Error, -1, string.Format("Error executing '{0}' package action. {1}", ActionAlias, ex));
				return false;
			}
		}
		...
		private bool getAttribute(XmlNode xmlData, string attribute, out string value)
		{
			...
			{
				Log.Add(LogTypes.Error, -1, string.Format("Error with '{0}' package action: Attribute '{1}' not found.", ActionAlias, attribute));
			}
